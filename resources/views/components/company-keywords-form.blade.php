<div class="company-keywords">
    <div class="company-keywords-form">
    	<fieldset class="fieldset-border">
			<legend class="legend-border">Company's Name</legend>
			<input type="text" class="fieldset-input" id="company-name" placeholder="Your Company's Name">
		</fieldset>
